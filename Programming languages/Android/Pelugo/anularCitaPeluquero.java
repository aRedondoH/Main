...
public class anularCitaPeluquero extends Activity{
	...
	private Button botonAnularTodas;
	private EditText nombreCliente;
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState); 
        setContentView(R.layout.actividad_anularcitapeluquero);
        cubileteCitas=(EditText) findViewById(R.id.editTextVerCitas);
        botonAnular = (Button) findViewById(R.id.buttonAnular);
        botonAnularTodas = (Button) findViewById(R.id.buttonAnularTodas);
        nombreCliente = (EditText) findViewById (R.id.editTextNombreClienteAnular);
     ...
     // Utilizamos la clase Httpclient para conectar
        ...
        HttpPost httppost = new HttpPost("http://"+IP_Server+"/droidlogin/verTodasLasCitas.php");      
        try { 
        ...
        botonAnular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
           	...
           	// Utilizamos la clase Httpclient para conectar
                ...
                // Utilizamos la HttpPost para enviar lso datos
                // A la url donde se encuentre nuestro archivo receptor
                HttpPost httppost = new HttpPost("http://"+IP_Server+"/droidlogin/anularUnaCita.php");      
                try { 
                	List<NameValuePair> postValues = new ArrayList<NameValuePair>(2);         
        ...
        botonAnularTodas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                	...
                	// Utilizamos la clase Httpclient para conectar
                     ...
                     // Utilizamos la HttpPost para enviar lso datos
                     // A la url donde se encuentre nuestro archivo receptor
                     HttpPost httppost = new HttpPost("http://"+IP_Server+"/droidlogin/anularTodasLasCitas.php");      
                     try { 
                     	List<NameValuePair> postValues = new ArrayList<NameValuePair>(2);         
                         //postValues.add(new BasicNameValuePair("user", cliente));
