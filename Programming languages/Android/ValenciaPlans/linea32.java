...
public class linea32 extends Activity implements OnTouchListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linea32);
        ImageView view = (ImageView) findViewById(R.id.imageViewlinea32);
