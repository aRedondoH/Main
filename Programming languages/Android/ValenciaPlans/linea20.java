...
public class linea20 extends Activity implements OnTouchListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linea20);
        ImageView view = (ImageView) findViewById(R.id.imageViewlinea20);
