...
/* Common processes */
char *arrayOfCommonProcessesFake[MAXNUMBERPROCESSES];
int currentPositionMainListFake = -1;
int numberOfCommonProcessesFake = 0;

int currentPositionTempListFake = 0;
char *arrayOfCommonProcessesTempFake[MAXNUMBERPROCESSES];
int numberOfCommonProcessesTempFake = 0;
...
void parsingLineFake(char line[200]) {
