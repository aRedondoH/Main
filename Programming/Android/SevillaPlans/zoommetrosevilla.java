...
public class zoommetrosevilla extends Activity implements OnTouchListener{
	...
	// Estas matrices se utilizarán para mover y hacer zoom sobre la imagen
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.metrosevilla);
	        ImageView view = (ImageView) findViewById(R.id.imagemetroparazoom);
