...
public class linea31 extends Activity implements OnTouchListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linea31);
        ImageView view = (ImageView) findViewById(R.id.imageViewlinea31);
