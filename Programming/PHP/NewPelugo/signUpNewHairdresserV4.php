...
/* Prepare statement */
if (!$stmt=$mysqli->prepare("INSERT INTO peluquerias (id_pelu, nombre, direccion, ciudad, provincia, horario, correo, telefono, map) VALUES (0,?,?,?,?,?,?,?,?)")){
...
/* Bind parameters*/
if (!$stmt->bind_param('ssssssss',$nameHairdresser,$adressToSafe, $cityToSafe, $provinceToSafe, $timetableToSafe, $emailToSafe, $phoneToSafe, $mapToShow)) {
