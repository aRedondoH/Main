...
//$result = mysql_query("SELECT * FROM citas WHERE confirmacion='no' AND peluqueria='$usuario' "); 
$result = mysql_query("SELECT * FROM citas WHERE confirmacion='no' "); 
echo ""; 
echo ""; 
$d = date("d"); 
$m = date("m"); 
...
//echo "<table border="1" cellpadding="5" cellspacing="8" width="600">
	echo "<table>";
